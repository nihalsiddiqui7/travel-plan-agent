...
DEFAULT_ORIGIN_IATA = os.getenv("DEFAULT_ORIGIN_IATA", "IXU")
...
def clean_text(text):
    ...
    stop_words= ["airport", "airports", "city", "cities", "country", "countries", "flight", "flights"]
...
#     print(search_flights("Plan a 7 days Japan trip from Aurangabad"))
#     print("\n" + "=" * 80 + "\n")
